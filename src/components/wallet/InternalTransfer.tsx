  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Transfer money to other users instantly</p>
      </div>
      ...
      <div className="flex bg-gray-50 rounded-2xl p-1 mb-8">
        ...
        >
          <IoSendOutline className="w-5 h-5 inline mr-2" />
          Send Money
        </button>
        <button
        ...
        >
          <IoRefreshOutline className="w-5 h-5 inline mr-2" />
          History
        </button>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                placeholder="0.00"
                className="w-full px-4 py-4 text-xl font-semibold text-gray-900 placeholder-gray-400 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
              {selectedCurrency && (
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-4 text-gray-900 placeholder-gray-400 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent pl-12"
              />
          ...
          <div className="mb-8">
            ...
            <input
              ...
              className="w-full px-4 py-3 text-gray-900 placeholder-gray-400 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-4 px-6 rounded-xl font-semibold hover:from-blue-600 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center gap-2"
          >
            {sending ? (
              <>
