  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Muted colors for secondary text and elements
        muted: {
        ...
        // Primary and secondary for buttons
        primary: {
      ...
      boxShadow: {
        ...
        'glow-lg': '0 0 40px rgb(99 102 241 / 0.15)',
        'brand': '0 4px 14px 0 rgb(99 102 241 / 0.15)',
      },
